 ...
 * @copyright  Copyright (C) 2000  Network Applied Communication Laboratory,
 * Inc.
 * @copyright  Copyright (C) 2000  Information-technology Promotion Agency,
 * Japan
...
/** @cond INTERNAL_MACRO */
    ...
    defined(HAVE_STMT_AND_DECL_IN_EXPR)
#define rb_varargs_argc_check_runtime(argc, vargc)                             \
  (((argc) <= (vargc))                                                         \
       ? (argc)                                                                \
       : (rb_fatal("argc(%d) exceeds actual arguments(%d)", argc, vargc), 0))
...
ERRORFUNC((" argument length doesn't match"),
...
#define rb_varargs_argc_check(argc, vargc)                                     \
  __builtin_choose_expr(__builtin_constant_p(argc),                            \
                        (rb_varargs_argc_valid_p(argc, vargc)                  \
                             ? (argc)                                          \
